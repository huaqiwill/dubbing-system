...
<template>
  <div class="signinform">
        ...
        <div class="w3_info">
          ...
          <form action="#" method="post">
            <div class="input-group">
              ...
              <input type="email" placeholder="请输入用户名" required="" />
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
              <span><i class="fas fa-key" aria-hidden="true"></i></span>
              <input type="password" placeholder="请输入验证码" required="" />
            </div>
          ...
          <p class="account">还没有账号? <a href="#signup">立即注册</a></p>
        </div>
      </div>
      <!-- //main content -->
    </div>
    ...
    <!-- <div class="footer">
        <p>
          &copy; 2020 Play Sign In form. All Rights Reserved | Design by
