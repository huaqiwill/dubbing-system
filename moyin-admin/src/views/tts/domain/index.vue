<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="领域值" prop="name">
        <el-input
          v-model="queryParams.name"
          placeholder="请输入领域名称"
          clearable
      ...
      <el-form-item label="领域状态" prop="status">
        <el-select
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['moyin:domain:remove']"
        >
          删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['moyin:domain:export']"
        >
          导出
        </el-button>
      </el-col>
    ...
    >
      ...
      <el-table-column label="领域值" align="center" prop="value" />
      <el-table-column label="领域状态" align="center" prop="status">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="领域值" prop="value">
          <el-input v-model="form.value" placeholder="请输入领域值" />
        </el-form-item>
        <el-form-item label="领域状态" prop="status">
          <el-select
            v-model="form.status"
